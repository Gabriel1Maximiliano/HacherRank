/**
 * 
 * Definimos un cuadrado mágico como una n x n matriz de enteros positivos 
 * distintos desde hasta donde la suma de cualquier fila, 
 * columna o diagonal de longitud es siempre igual al mismo número: la constante mágica.

Se le dará una matriz de enteros en el rango inclusivo[1,9]. 
Podemos convertir cualquier dígito "a" a cualquier otro dígito "b" en el rango [1,9] 
al costo de | a - b |. Dado "s", conviértalo en un cuadrado mágico a un costo mínimo. Imprima este costo en una nueva línea.

Nota: El cuadrado mágico resultante debe contener números enteros 
distintos en el rango inclusivo.
 */
